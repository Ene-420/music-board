...
export async function insertIntoSongTable(Track){
...
export async function insertIntoTrackCover(TrackCover){
...
export async function addToUserLibrary(userID, trackID, albumID, coverID){
